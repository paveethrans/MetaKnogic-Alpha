...
PROMPTS["fail_response"] = "Sorry, I'm not able to provide an answer to that question. Please provide more specific information."
...
You can do deep research and reasoning to find the answer. Do not include information where the supporting evidence for it is not provided.
Attach the PMC IDs of the articles that you used to answer the question in the response. Attach the PMC IDs to the corresponding sections in the response.
Do not let the users think the answer is generated by chatgpt.
